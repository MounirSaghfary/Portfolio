...
const Details = ({ position, company, companyLink, time, address, work }) => {
  ...
  return (
    <li
      ref={ref}
      className='my-8 first:mt-0 last:mb-0 w-full md:w-[60%] mx-auto flex flex-col items-center justify-between'
    >
...
const Experience = () => {
  ...
  return (
    <div className='my-20 md:my-64 bg-slate-200 shadow-lg rounded-lg p-8'>
      <h2 className='font-bold text-8xl mb-10 md:mb-32 w-full text-center'>
        Experience
      </h2>
      <div
        ref={ref}
        className='w-full md:w-[75%] mx-auto relative overflow-hidden'
      >
        <motion.div
